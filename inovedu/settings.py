# Django settings for InovEdu project.
...
SECRET_KEY = 'c&fso0pdw=!!*j+m@2v(90o^8$lyvn67d8kwn1^0930)41bwce'
...
ROOT_URLCONF = 'inovedu.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'inovedu.wsgi.application'
